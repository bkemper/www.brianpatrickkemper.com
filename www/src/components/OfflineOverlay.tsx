  ...
  return (
    <Dialog.Root open={isWindowOnline === false}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="animate-[fadeIn_1s_ease-in-out_1] fixed top-0 max-w-md border border-forest/20 bg-bone p-6 text-forest dark:border-bone/20 dark:bg-forest-mid dark:text-bone">
