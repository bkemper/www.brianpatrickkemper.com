...
function Home() {
  return (
    <div className="bg-day dark:bg-night min-h-screen min-w-screen relative">
      <a
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:bg-night focus:px-4 focus:py-2 focus:text-day dark:focus:bg-day dark:focus:text-night"
        href="#main"
      >
      ...
      <main id="main">
        ...
        <section className="p-16 md:px-32">
          ...
          <ul className="flex flex-row-reverse flex-wrap gap-4 justify-center-safe">
            <li>
              <LogoLink
                ariaLabel="Pie Insurance on LinkedIn"
            ...
            <li>
              <LogoLink
                ariaLabel="Visual Lease on LinkedIn"
            ...
            <li>
              <LogoLink ariaLabel="Facet on LinkedIn" href="//www.linkedin.com/company/joinfacet/">
                <FacetLogo />
              </LogoLink>
            </li>
            <li>
              <LogoLink
                ariaLabel="SparkPost on LinkedIn"
            ...
            <li>
              <LogoLink ariaLabel="STAQ on LinkedIn" href="//www.linkedin.com/company/staq/">
                <StaqLogo />
              </LogoLink>
            </li>
          </ul>
      ...
      <footer>
        <ul className="flex gap-4 justify-center p-16 text-sm text-gray">
          <li>
            <span suppressHydrationWarning>{new Date().getFullYear()}</span> &copy;{" "}
